...
- Фильмы по расписанию хранятся в `~/MM/DD/HH-MM/`
- Клиповые плейлисты хранятся в `~/clips/`
...
- Включение и отключение элементов расписания двойным кликом
...
1. Откройте вкладку `Фильмы`.
2. Найдите нужный месяц и день.
3. Перетащите видеофайл на нужный день.
4. Выберите время.
5. Подтвердите добавление.

Файл будет загружен в каталог вида `~/MM/DD/HH-MM/filename.ext` и добавлен в расписание daemon.

### Управление плейлистами

1. Откройте вкладку `Клипы`.
2. Нажмите `Создать плейлист`.
3. Укажите имя.
4. Перетащите файлы в область загрузки.
5. Дважды кликните по плейлисту, чтобы сделать его активным.

Файлы плейлиста загружаются в `~/clips/<playlist_name>/`.
...
- `~/MM/DD/HH-MM/` - файлы расписания
- `~/clips/` - файлы плейлистов
